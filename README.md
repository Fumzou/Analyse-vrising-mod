...
This repository holds a single decompiled C# source file from a VRising BepInEx mod. All other artifacts from the original dump were removed for clarity.
